...
from common_modules.colors import get_random_colors
from common_modules.common_objects import get_bbox_center
import math
...
class Demonstrator:
    ...
    def make_demonstration(self, annotation_storage):
        ...
        for frame_index in tqdm(frame_range, desc="Writing images"):
            ...
            # Uncomment next line to save processed images to --dst_folder
            # cv2.imwrite(dst_img_path.as_posix(), img)
            writer.write(cv2.resize(img, (1920, 1080)))
