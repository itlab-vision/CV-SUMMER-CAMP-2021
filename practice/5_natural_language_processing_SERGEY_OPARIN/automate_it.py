...
def build_argparser():
    ...
    parser.add_argument("-s", required=True, help="Path to the input sites file")
    parser.add_argument("-m", required=True, help="Path to the model")
    parser.add_argument("--fq", required=False, help="Flag of reading questions from file 'questions.txt' (True, False)", default=False)
    parser.add_argument("--fs", required=False, help="Flag of reading sites from file 'pages.txt' (True, False)", default=False)
    return parser
